function Footer() {
  return (
    <>
      <footer className="bg-gray-900 text-white py-12 px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-4 mb-4 md:mb-0 md:justify-end">
          <a
